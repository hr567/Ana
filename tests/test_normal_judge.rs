...
fn test_normal_judge_with_ce() -> io::Result<()> {
    let judge_info = generate_judge_info("example/source.ce.cpp", "example/problem.json", None)?;
...
fn test_normal_judge_with_mle() -> io::Result<()> {
    let judge_info = generate_judge_info("example/source.mle.cpp", "example/problem.json", None)?;
...
fn test_normal_judge_with_re() -> io::Result<()> {
    let judge_info = generate_judge_info("example/source.re.cpp", "example/problem.json", None)?;
...
fn test_normal_judge_with_tle() -> io::Result<()> {
    let judge_info = generate_judge_info("example/source.tle.cpp", "example/problem.json", None)?;
...
fn test_normal_judge_with_wa() -> io::Result<()> {
    let judge_info = generate_judge_info("example/source.wa.cpp", "example/problem.json", None)?;
