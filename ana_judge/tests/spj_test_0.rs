...
#[test]
fn test_spj_0_judge_with_ac() -> io::Result<()> {
...
#[test]
fn test_spj_0_judge_with_ce() -> io::Result<()> {
    let ana = Container::new()?;
    let communicator = Communicator::new(&ana.ip_address()?)?;
    let judge_info = common::generate_judge_info(
...
#[test]
fn test_spj_0_judge_with_mle() -> io::Result<()> {
    let ana = Container::new()?;
    let communicator = Communicator::new(&ana.ip_address()?)?;
    let judge_info = common::generate_judge_info(
...
#[test]
fn test_spj_0_judge_with_re() -> io::Result<()> {
    let ana = Container::new()?;
    let communicator = Communicator::new(&ana.ip_address()?)?;
    let judge_info = common::generate_judge_info(
...
#[test]
fn test_spj_0_judge_with_tle() -> io::Result<()> {
    let ana = Container::new()?;
    let communicator = Communicator::new(&ana.ip_address()?)?;
    let judge_info = common::generate_judge_info(
...
#[test]
fn test_spj_0_judge_with_wa() -> io::Result<()> {
    let ana = Container::new()?;
    let communicator = Communicator::new(&ana.ip_address()?)?;
    let judge_info = common::generate_judge_info(
